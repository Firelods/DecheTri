...
public class ItineraryNotification implements INotification {
    private final NotificationPermissionCallback callback;
    private final Activity activity;
    private final Context context;

    public ItineraryNotification(NotificationPermissionCallback callback, Activity activity, Context context) {
