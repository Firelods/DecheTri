...
public class ReportNotification implements INotification {
    private final NotificationPermissionCallback callback;
    private final Activity activity;
    private final Context context;

    public ReportNotification(NotificationPermissionCallback callback, Activity activity, Context context) {
